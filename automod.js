...
const LOG_CHANNEL_ID = "1461248761161584673";
const MUTED_ROLE_ID = "1421229014516760637";
const HELPER_ROLE_ID = "1417925282903621683";
const MOD_ROLE_ID = "1417921850670977054";
const ADMIN_ROLE_ID = "1417921521787338822";
const HEAD_ADMIN_ROLE_ID = "1418702663465566330";
...
async function applyWarn(client, guild, user, member, reason, detectedWord = null, staffUser = null) {
  ...
  const embed = new EmbedBuilder()
    ...
    .setFooter({ text: "ArrozBOT - Moderación" })
    .setTimestamp()
    .setColor(warnCount === 1 ? "#FFFF00" : "#FF0000");
